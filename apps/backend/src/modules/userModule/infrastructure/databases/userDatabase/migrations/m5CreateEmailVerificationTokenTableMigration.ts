...
export class M5CreateVerificationTokenTableMigration implements Migration {
  public name = 'M5CreateVerificationTokenTableMigration';

  private readonly tableName = 'emailVerificationTokens';
