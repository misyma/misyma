...
export class M3CreateBlacklistTokenTableMigration implements Migration {
  public name = 'M3CreateBlacklistTokenTableMigration';
  ...
  public async up(databaseClient: DatabaseClient): Promise<void> {
    await databaseClient.schema.createTable(this.tableName, (table) => {
      ...
      table.timestamp(this.columns.expiresAt).nullable();
