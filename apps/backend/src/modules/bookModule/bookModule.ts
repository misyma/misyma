...
import { ApplyBookChangeRequestCommandHandlerImpl } from './application/commandHandlers/applyBookChangeRequestCommandHandler/applyBookChangeRequestCommandHandlerImpl.js';
...
import { CreateBookChangeRequestCommandHandlerImpl } from './application/commandHandlers/createBookChangeRequestCommandHandler/createBookChangeRequestCommandHandlerImpl.js';
...
import { CreateCollectionCommandHandlerImpl } from './application/commandHandlers/createCollectionCommandHandler/createCollectionCommandHandlerImpl.js';
...
import { CreateCategoryCommandHandlerImpl } from './application/commandHandlers/createCategoryCommandHandler/createCategoryCommandHandlerImpl.js';
...
import { DeleteBookChangeRequestCommandHandlerImpl } from './application/commandHandlers/deleteBookChangeRequestCommandHandler/deleteBookChangeRequestCommandHandlerImpl.js';
...
import { DeleteCollectionCommandHandlerImpl } from './application/commandHandlers/deleteCollectionCommandHandler/deleteCollectionCommandHandlerImpl.js';
...
import { DeleteCategoryCommandHandlerImpl } from './application/commandHandlers/deleteCategoryCommandHandler/deleteCategoryCommandHandlerImpl.js';
...
import { UpdateCollectionCommandHandlerImpl } from './application/commandHandlers/updateCollectionCommandHandler/updateCollectionCommandHandlerImpl.js';
...
import { UpdateCategoryCommandHandlerImpl } from './application/commandHandlers/updateCategoryCommandHandler/updateCategoryCommandHandlerImpl.js';
...
import { FindCategoriesriesQueryHandlerImpl } from './application/queryHandlers/CategoriestegoriesQueryHandCategoriesndCategoriesQueryHandlerImpl.js';
...
import { FindBookChangeRequestsQueryHandlerImpl } from './application/queryHandlers/findBookChangeRequestsQueryHandler/findBookChangeRequestsQueryHandlerImpl.js';
...
import { FindBookReadingsueryHandlerImpl } from './application/queryHandlers/findBookReadingsQueryHandler/findBookReadingsQueryHandlerImpl.js';
...
import { FindCollectionsQueryHandlerImpl } from './application/queryHandlers/findCollectionsQueryHandler/findCollectionsQueryHandlerImpl.js';
import { type FindQuotesQueryHandler } from './application/queryHandlers/findQuotesQueryHandler/findQuotesQueryHandler.js';
import { FindQuotesQueryHandlerImpl } from './application/queryHandlers/findQuotesQueryHandler/findQuotesQueryHandlerImpl.js';
...
import { type CategoryMapper } from './infrastructure/repositories/categoryRepository/categoryMapper/categoryMapper.js';
import { CategoryMapperImpl } from './infrastructure/repositories/categoryRepository/categoryMapper/categoryMapperImpl.js';
import { CategoryRepositoryImpl } from './infrastructure/repositories/categoryRepository/categoryRepositoryImpl.js';
import { type CollectionMapper } from './infrastructure/repositories/collectionRepository/collectionMapper/collectionMapper.js';
import { CollectionMapperImpl } from './infrastructure/repositories/collectionRepository/collectionMapper/collectionMapperImpl.js';
import { CollectionRepositoryImpl } from './infrastructure/repositories/collectionRepository/collectionRepositoryImpl.js';
...
export class BookModule implements DependencyInjectionModule {
  ...
  private bindMappers(container: DependencyInjectionContainer): void {
    ...
    container.bind<CategoryMapper>(symbols.categoryMapper, () => new CategoryMapperImpl());
  ...
  private bindRepositories(container: DependencyInjectionContainer): void {
    ...
    container.bind<CollectionRepository>(
  ...
  private bindCommandHandlers(container: DependencyInjectionContainer): void {
    ...
    container.bind<CreateCategoryCommandHandler>(
      symbols.createCategoryCommandHandler,
      () =>
        new CreateCategoryCommandHandlerImpl(
          container.get<CategoryRepository>(symbols.categoryRepository),
          container.get<LoggerService>(coreSymbols.loggerService),
        ),
    );

    container.bind<DeleteCategoryCommandHandler>(
      symbols.deleteCategoryCommandHandler,
      () =>
        new DeleteCategoryCommandHandlerImpl(
          container.get<CategoryRepository>(symbols.categoryRepository),
          container.get<LoggerService>(coreSymbols.loggerService),
        ),
    );

    container.bind<UpdateCategoryCommandHandler>(
      symbols.updateCategoryCommandHandler,
      () =>
        new UpdateCategoryCommandHandlerImpl(
          container.get<CategoryRepository>(symbols.categoryRepository),
          container.get<LoggerService>(coreSymbols.loggerService),
        ),
    );
    ...
    container.bind<CreateCollectionCommandHandler>(
    ...
    container.bind<DeleteCollectionCommandHandler>(
    ...
    container.bind<UpdateCollectionCommandHandler>(
    ...
    container.bind<ApplyBookChangeRequestCommandHandler>(
      symbols.applyBookChangeRequestCommandHandler,
      () =>
    ...
    container.bind<CreateBookChangeRequestCommandHandler>(
      symbols.createBookChangeRequestCommandHandler,
      () =>
        new CreateBookChangeRequestCommandHandlerImpl(
          container.get<BookChangeRequestRepository>(symbols.bookChangeRequestRepository),
          container.get<BookRepository>(symbols.bookRepository),
    ...
    container.bind<DeleteBookChangeRequestCommandHandler>(
      symbols.deleteBookChangeRequestCommandHandler,
      () =>
        new DeleteBookChangeRequestCommandHandlerImpl(
          container.get<BookChangeRequestRepository>(symbols.bookChangeRequestRepository),
          container.get<LoggerService>(coreSymbols.loggerService),
        ),
    );
  ...
  private bindQueryHandlers(container: DependencyInjectionContainer): void {
    ...
    container.bind<FindCategoriesriesQueryHandler>(
      symbols.findCategoriesriesQueryHandler,
      () => new FindCategoriesriesQueryHandlerImpl(container.get<CategoryRepository>(symbols.categoryRepository)),
    );
    ...
    container.bind<FindUserBookQueryHandler>(
      ...
      () =>
        new FindUserBookQueryHandlerImpl(
          container.get<UserBookRepository>(symbols.userBookRepository),
          container.get<BookshelfRepository>(bookshelfSymbols.bookshelfRepository),
        ),
    );
    ...
    container.bind<FindBookReadingsQueryHandler>(
      symbols.findBookReadingsQueryHandler,
      () =>
        new FindBookReadingsueryHandlerImpl(
          container.get<BookReadingRepository>(symbols.bookReadingRepository),
          container.get<UserBookRepository>(bookSymbols.userBookRepository),
        ),
    );
    ...
    container.bind<CategoryHttpController>(
      ...
      () =>
        new CategoryHttpController(
          container.get<FindCategoriesriesQueryHandler>(symbols.CategoriestegoriesQueryHandler),
          container.get<AccessControlService>(authSymbols.accessControlService),
        ),
    );

    container.bind<CategoryAdminHttpController>(
      symbols.categoryAdminHttpController,
      () =>
        new CategoryAdminHttpController(
          container.get<CreateCategoryCommandHandler>(symbols.createCategoryCommandHandler),
          container.get<UpdateCategoryCommandHandler>(symbols.updateCategoryCommandHandler),
          container.get<DeleteCategoryCommandHandler>(symbols.deleteCategoryCommandHandler),
          container.get<AccessControlService>(authSymbols.accessControlService),
        ),
    );
    ...
    container.bind<CollectionHttpController>(
      ...
      () =>
        new CollectionHttpController(
          ...
          container.get<UpdateCollectionCommandHandler>(symbols.updateCollectionCommandHandler),
          container.get<DeleteCollectionCommandHandler>(symbols.deleteCollectionCommandHandler),
          container.get<FindCollectionsQueryHandler>(symbols.findCollectionsQueryHandler),
          container.get<AccessControlService>(authSymbols.accessControlService),
        ),
    );
    ...
    container.bind<BookReadingHttpController>(
      ...
      () =>
        new BookReadingHttpController(
          container.get<FindBookReadingsQueryHandler>(symbols.findBookReadingsQueryHandler),
    ...
    container.bind<QuoteHttpController>(
      ...
      () =>
        new QuoteHttpController(
          container.get<FindQuotesQueryHandler>(symbols.findQuotesQueryHandler),
