...
it('validates form input', async () => {
  ...
  expect(await screen.findByText('Imię i nazwisko autora musi miec co najmniej trzy znaki.')).toBeVisible();
...
it('submits form successfully', async () => {
  ...
  expect(await screen.findByText('Autor: John Doe został stworzony.')).toBeVisible();
});
