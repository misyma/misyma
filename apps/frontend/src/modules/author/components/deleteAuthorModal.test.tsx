...
it('opens the modal when delete button is clicked', async () => {
  ...
  expect(screen.getByText('Usunięcia autora jest nieodwracalne!')).toBeInTheDocument();
...
it('closes the modal when "Nie" button is clicked', async () => {
  ...
  expect(screen.queryByText('Usunięcia autora jest nieodwracalne!')).not.toBeInTheDocument();
});
