...
export type BookshelfBooksSearchParams = z.infer<typeof bookshelfBooksSearchParamsSchema>;

export const BookshelfBooksPageFiltersBar = () => {
  const navigate = useNavigate();
  const search = useSearch({
    from: '/shelves/bookshelf/$bookshelfId',
  }) as BookshelfBooksSearchParams;
