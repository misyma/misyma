...
const BookCreationContext = createContext<BookCreationState<true>>(
	null as unknown as BookCreationState<true>
);
...
export function BookCreationProvider({
	children,
}: {
	children: ReactNode;
}): JSX.Element {
	const [bookCreation, dispatch] = useReducer(
		bookCreationReducer,
		initialState
	);
	...
	return (
		<BookCreationContext.Provider
			value={bookCreation as unknown as BookCreationState<true>}
		>
