...
export interface FindBooksByBookshelfIdPayload
	extends FindUserBooksQueryParams {
	accessToken: string;
	userId: string;
}

export const findBooksByBookshelfId = async (
	values: FindBooksByBookshelfIdPayload
) => {
