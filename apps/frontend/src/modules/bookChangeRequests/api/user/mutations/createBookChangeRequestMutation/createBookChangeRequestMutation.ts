import { CreateBookChangeRequestRequestBody, CreateBookshelfResponseBody } from '@common/contracts';
...
export const useCreateBookChangeRequestMutation = (
  options: UseMutationOptions<CreateBookshelfResponseBody, BookApiError, Payload>,
) => {
