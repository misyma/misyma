...
import { type BookshelfState } from './bookshelvesState';
...
export const setEditMap = createAction<Record<number, boolean>>('bookshelves/setEditMap');

export const setCreatingNew = createAction<boolean>('bookshelves/setCreatingNew');
